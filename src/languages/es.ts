...
const translations: TranslationDeepObject<typeof en> = {
    ...
    walletPage: {
        ...
        cardLastSynced: (relativeDate: string) => `Sincronizada ${relativeDate}`,
        cardNeverSynced: 'Nunca sincronizada',
        cardStatus: {
            active: 'Activa',
            inactive: 'Inactiva',
            fixConnection: 'Corrige esta conexión',
            fixConnectionIn: 'Corrige esta conexión en',
            companyCardsLink: 'tarjetas de empresa',
            askAdminToFixConnection: 'Pide a un administrador que corrija esta conexión',
        },
        bankAccountStatus: {
            active: 'Activa',
            ...
            finishAddingBankAccount: 'Termina de añadir la cuenta bancaria',
            finish: 'Finalizar',
