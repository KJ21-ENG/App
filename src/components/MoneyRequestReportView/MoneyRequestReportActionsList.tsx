...
function MoneyRequestReportActionsList({reportID: reportIDProp, onLayout}: MoneyRequestReportListProps) {
    ...
    const reportID = getNonEmptyStringOnyxID(reportIDProp);
    ...
    const beginExportWithTemplate = useCallback(
        ...
        [isOffline, report, reportID, policy?.id, showConfirmModal, translate, clearSelectedTransactions],
    );
    ...
    }, [rejectModalAction, report?.reportID, reportID]);
    ...
    useEffect(() => {
        ...
        // eslint-disable-next-line react-hooks/exhaustive-deps
    }, [report?.lastVisibleActionCreated, transactionThreadReport?.lastVisibleActionCreated, reportID, isVisible, reportMetadata?.hasOnceLoadedReportActions]);
    ...
    const renderItem = useCallback(
        ({item: reportAction, index}: ListRenderItemInfo<OnyxTypes.ReportAction>) => {
            ...
            const originalReportID = getOriginalReportID(reportID, reportAction, reportActionsObject);
    ...
    const scrollToBottomAndMarkReportAsRead = useCallback(() => {
        ...
        readNewestAction(reportID, !!reportMetadata?.hasOnceLoadedReportActions);
    }, [setIsFloatingMessageCounterVisible, hasNewestReportAction, reportScrollManager, reportID, reportMetadata?.hasOnceLoadedReportActions, introSelected, betas]);
